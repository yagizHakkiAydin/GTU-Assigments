...
/**
*This class keeps all data about the street in Linked list
*This class has functions to modify structures(including playgrounds)
*/
public class StreetLinkedList extends Street
{
	...
	*/
	StreetLinkedList( int lengthOfStreet )
	{
		super(lengthOfStreet);
		leftSideOfTheStreet =  new LinkedList<Structure>();;
		rightSideOfTheStreet =  new LinkedList<Structure>();;
	}
	...
	*/
	...
	public void deleteHouse( String side )
	{
		...
		LinkedList<Structure> streetSide = null;
	...
	*/
	...
	LinkedList<Structure> leftSideOfTheStreet;
	LinkedList<Structure> rightSideOfTheStreet;
}