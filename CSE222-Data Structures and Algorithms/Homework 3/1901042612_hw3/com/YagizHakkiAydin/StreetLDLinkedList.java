...
/**
*This class keeps all data about the street in LDLinkedList
*This class has functions to modify structures(including playgrounds)
*/
public class StreetLDLinkedList extends Street
{
	...
	StreetLDLinkedList( int lengthOfStreet )
	{
		super(lengthOfStreet);
		leftSideOfTheStreet =  new LDLinkedList<Structure>();
		rightSideOfTheStreet =  new LDLinkedList<Structure>();
	}
	...
	*/
	...
	public void deleteHouse( String side )
	{
		...
		LDLinkedList<Structure> streetSide = null;
	...
	*/
	...
	LDLinkedList<Structure> leftSideOfTheStreet;
	LDLinkedList<Structure> rightSideOfTheStreet;
}